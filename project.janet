...
(declare-executable :name "in" :entry "in.janet" :install true)
(declare-executable :name "list" :entry "list.janet" :install true)
(declare-executable :name "each" :entry "each.janet" :install true)
